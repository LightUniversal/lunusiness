...
const PhoneSwappingPage = () => {
  ...
  return (
    <div className="container mx-auto p-5 relative top-10 my-5">
      <h1 className="text-xl text-slate-700 flex justify-center gap-5 items-center py-2 font-bold text-center mb-5">
        Classical Phone Swap
        <FaExchangeAlt className=' text-green-900' />
      </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        {phones.map((phone) => (
          <div
            key={phone.id}
            className={`p-4 border border-slate-100 shadow-sm rounded-lg ${
          ...
          >
            ...
            <p className="text-lg font-medium justify-between flex items-center text-green-600">
            ...
            Swap <FaExchangeAlt className=' text-green-500' />
        </Link>
            </p>
          </div>
        ))}
