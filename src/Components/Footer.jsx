      ...
      <div className="footer p-10  border-t w-full flex  gap-10 flex-wrap  text-white md:justify-between">
        <div className="name text-white md:w-3/12">
          <h2 className="text-lg mb-1 font-medium">
            <abbr title="Light Universal Intelligence" className=" text-sm no-underline text-blue-100">
        ...
        <div className="links text-white ">
          ...
          <div className="others">
            ...
            <div className=" flex  flex-col gap-3 ">
              <a href="/" className=" flex items-center  text-sm text-blue-500 gap-3">
                Home
              </a>
              <a href="/" className=" flex items-center text-sm text-blue-500 gap-3">
                About
          ...
          <div className="form">
            <form action="#" className="flex gap-2 flex-wrap">
              <input
                ...
                className=" p-3 border border-slate-800 w-full text-slate-800 text-sm font-medium bg-slate-900 outline-none rounded-md"
              />
              <button
                type="submit"
                className="flex gap-3 items-center border-none bg-blue-700 text-sm font-medium p-3 text-white px-3 rounded-md"
              >
                Submit <FaEnvelope />{" "}
              </button>
            </form>
